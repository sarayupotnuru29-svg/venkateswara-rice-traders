...
const Footer = () => {
  ...
  return (
    <footer className="bg-secondary text-secondary-foreground relative">
      <div className="container mx-auto px-4 py-12 lg:py-16">
        ...
        <div className="mt-12 pt-6 border-t border-border/30 text-center text-sm text-muted-foreground space-y-4">
          ...
          <div className="flex justify-center items-center gap-1 flex-wrap">
            ...
            >
              <img src="/staffarclogo.jpg" alt="StaffArc logo" className="h-5 w-5 object-contain rounded-sm" />
              StaffArc
            </a>
          </div>
        </div>
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-6 right-6 z-40 bg-green-gradient text-primary-foreground w-12 h-12 rounded-full flex items-center justify-center shadow-lg hover:opacity-90 transition-opacity"
